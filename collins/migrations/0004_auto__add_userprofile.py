...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('collins_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_managed_blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collins.Blog'], null=True, blank=True)),
        ))
        db.send_create_signal('collins', ['UserProfile'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('collins_userprofile')
