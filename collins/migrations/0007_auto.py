...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field permitted_post_types on 'Blog'
        db.create_table('collins_blog_permitted_post_types', (
        ...
        db.create_unique('collins_blog_permitted_post_types', ['blog_id', 'contenttype_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field permitted_post_types on 'Blog'
        db.delete_table('collins_blog_permitted_post_types')
